package com.osipov.server.aspect;
...
public class LoggingAspect {
    ...
    @Before("execution(* com.osipov.server.*.controller.*.*(..))")
    ...
    @After("execution(* com.osipov.server.*.controller.*.*(..))")
    ...
    @AfterThrowing(value = "execution(* com.osipov.server.*.*.*.*(..))", throwing = "ex")
